...
class DatabaseService {
  ...
  Future<UserSettings> getUserSettings() async {
    ...
    return UserSettings(
      ...
      skipIntroLength: Duration(milliseconds: map['skipIntroLength'] ?? 30000),
      skipOutro: map['skipOutro'] == 1,
      skipOutroLength: Duration(milliseconds: map['skipOutroLength'] ?? 30000),
    );
  }
  ...
  Future<void> saveUserSettings(UserSettings settings) async {
    ...
    await db.update(
      'user_settings',
      {
        ...
        'favoriteUpdatesNotifications': settings.favoriteUpdatesNotifications ? 1 : 0,
